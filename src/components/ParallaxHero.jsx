      ...
      >
        ...
        >
          ...
          >
            <h1 className="text-4xl sm:text-5xl text-center md:text-left font-bold drop-shadow-lg md:col-span-2">
              ...
              >
                {/* <span>
                  ...
                  Hi, I'm Michael <span className="text-[#00fff4]"> - </span>{" "}
                </span> */}
            ...
            <p className="opacity-0 animate-fade-in-delay-3 mt-3 max-2-2xl mx-auto text-center md:col-start-1 md:col-span-2 md:text-left">
